...
context_triggers:
  - "When implementing account workflows"
  - "When managing account state"
  - "When handling account events"
  - "When implementing account queues"
  - "When coordinating account operations"
---

# Account Management Internal Systems Administration

## Core Principles
```yaml
purpose: "Administrative oversight of internal system integrations for account management"
key_aspects:
  - Component oversight
  - System coordination
