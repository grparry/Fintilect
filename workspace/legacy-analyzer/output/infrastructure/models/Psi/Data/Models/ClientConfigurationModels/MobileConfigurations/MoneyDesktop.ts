...
export class MoneyDesktop implements ISettingsGroup {
    ...
    constructor() {}
        ...
        toSettings(): Setting[] {
            return [
                { key: "MoneyDesktop.MinimumVersion", value: this._minimumVersion, dataType: 'string', label: "Minimum Version" },
                { key: "MoneyDesktop.MinimumAndroidVersion", value: this._minimumAndroidVersion, dataType: 'string', label: "Minimum Android Version" },
                { key: "MoneyDesktop.MinimumIosVersion", value: this._minimumIosVersion, dataType: 'string', label: "Minimum Ios Version" },
                { key: "MoneyDesktop.Enabled", value: this._enabled, dataType: 'boolean', label: "Enabled" },
                { key: "MoneyDesktop.Authentication", value: this._authentication, dataType: 'authentication.authentication', label: "Authentication" },
            ];
        }
